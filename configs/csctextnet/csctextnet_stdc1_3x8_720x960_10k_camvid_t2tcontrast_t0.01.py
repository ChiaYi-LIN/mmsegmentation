...
model = dict(
    ...
    auxiliary_head=[
        ...
        dict(
            ...
            in_index=5,
            loss_decode=dict(
                type='Text2TextContrastiveLoss', loss_weight=1.0, temperature=0.01, text_embeddings='/tmp3/linchiayi/mmsegmentation/pretrained/textfeat_camvid_11_RN50_1024.pth')),
    ]
)
