...
model = dict(
    ...
    init_cfg=dict(
        type='Pretrained',
        checkpoint=
        './work_dirs/stdc1_1x24_512x1024_scale0.5_60k_cityscapes/best.pth'))
...
checkpoint = './work_dirs/stdc1_1x24_512x1024_scale0.5_60k_cityscapes/best.pth'
work_dir = './work_dirs/entextnet_stdc1_1x24_512x1024_scale0.5_60k_cityscapes_finetune0.01'
gpu_ids = [0]
auto_resume = False
