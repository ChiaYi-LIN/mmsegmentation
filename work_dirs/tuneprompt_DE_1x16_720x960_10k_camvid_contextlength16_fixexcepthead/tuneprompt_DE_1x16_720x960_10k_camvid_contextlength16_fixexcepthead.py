...
model = dict(
    ...
    init_cfg=dict(
        type='Pretrained',
        checkpoint=
        './work_dirs/detextnet_stdc1_1x16_720x960_10k_camvid/best.pth'))
...
optimizer = dict(
    ...
    paramwise_cfg=dict(
        custom_keys=dict({
            ...
            'backbone.arms': dict(lr_mult=0.0),
            'backbone.convs': dict(lr_mult=0.0),
            'backbone.conv_avg': dict(lr_mult=0.0),
            'backbone.ffm': dict(lr_mult=0.0),
...
work_dir = './work_dirs/tuneprompt_DE_1x16_720x960_10k_camvid_contextlength16_fixexcepthead'
gpu_ids = [0]
auto_resume = False
