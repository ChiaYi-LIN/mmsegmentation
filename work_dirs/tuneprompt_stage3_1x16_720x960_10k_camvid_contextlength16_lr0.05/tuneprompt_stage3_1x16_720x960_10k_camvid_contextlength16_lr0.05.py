...
model = dict(
    ...
    init_cfg=dict(
        type='Pretrained',
        checkpoint=
        './work_dirs/tuneprompt_1x16_720x960_10k_camvid_contextlength16_fixbackbone/best.pth'
    ))
...
checkpoint = './work_dirs/tuneprompt_1x16_720x960_10k_camvid_contextlength16_fixbackbone/best.pth'
work_dir = './work_dirs/tuneprompt_stage3_1x16_720x960_10k_camvid_contextlength16_lr0.05'
gpu_ids = [0]
auto_resume = False
