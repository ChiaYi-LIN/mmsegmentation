    ...
    backbone=dict(
        ...
        backbone_cfg=dict(
            ...
            init_cfg=dict(
                type='Pretrained',
                checkpoint=
                'https://download.openmmlab.com/mmsegmentation/v0.5/pretrain/stdc/stdc2_20220308-7dbd9127.pth'
            )),
...
work_dir = './work_dirs/entextnet_stdc2_2x12_512x1024_scale0.5_160k_cityscapes'
gpu_ids = range(0, 2)
auto_resume = False
