...
class LangEncoderDecoder(BaseSegmentor):
    ...
    def __init__(self,
                 ...
                 pretrained=None,
                 init_cfg=None):
        super(LangEncoderDecoder, self).__init__(init_cfg)
    ...
    def _init_decode_head(self, decode_head):
        ...
        self.decode_head.text_embeddings = self.text_embeddings
        ...
        if auxiliary_head is not None:
            if isinstance(auxiliary_head, list):
                ...
                for head_cfg in auxiliary_head:
                    aux_head = builder.build_head(head_cfg)
                    aux_head.text_embeddings = self.text_embeddings
                    self.auxiliary_head.append(aux_head)
            else:
                self.auxiliary_head = builder.build_head(auxiliary_head)
                self.auxiliary_head.text_embeddings = self.text_embeddings
